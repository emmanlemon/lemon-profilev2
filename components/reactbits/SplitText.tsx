...
/**
 * React Bits "Split Text" (GSAP). The element stays hidden until fonts are
 * ready so the letters never flash before the animation starts.
...
const SplitText: React.FC<SplitTextProps> = ({
  ...
  const style: React.CSSProperties = {
    ...
    wordWrap: 'break-word',
    willChange: 'transform, opacity',
    visibility: fontsLoaded ? undefined : 'hidden',
  }
